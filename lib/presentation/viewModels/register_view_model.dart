...
class RegisterViewModel extends GetxController {
  ...
  void validateInputs() {
    ...
    if (isEmailTouched.value) {
      if (emailController.text.isEmpty) {
        emailError.value = 'Alamat email tidak boleh kosong';
      } else if (!emailController.text.contains('@')) {
        emailError.value = 'Alamat email tidak valid';
      } else {
  ...
  void handleRegister(
    ...
    if (fullNameError.value != null ||
        (selectedRole.value == 'seller' && storeNameError.value != null) ||
        emailError.value != null ||
        passwordError.value != null) {
  ...
  Future<void> createNewAccount(VoidCallback onRegisterSuccess) async {
    ...
    if (fullNameController.text.isEmpty ||
        ...
        (selectedRole.value == 'seller' && storeNameController.text.isEmpty)) {
      Message.error('Semua field harus diisi');
      return;
    }
