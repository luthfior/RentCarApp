      ...
      return PopScope(
        ...
        child: Scaffold(
          body: isLoading
              ...
              : buildCheckoutContent(context),
        ),
      );
    });
  }

  Widget buildCheckoutContent(BuildContext context) {
    return Stack(
      children: [
        SafeArea(
          child: Column(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        const Gap(20),
                        Obx(() {
                          if (controller.paymentMethodPicked.value == 'Tunai') {
                            return Padding(
        ...
        child: Column(
          children: [
            ...
            buildReceiptRow(
              'Nama Toko',
              isBold: true,
              controller.partner?.storeName ?? 'Tidak Ada',
            ),
