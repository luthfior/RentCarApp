...
class EditProfilePage extends GetView<ProfileViewModel> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      canPop: controller.fromPage == 'setting',
      onPopInvokedWithResult: (didPop, result) {
        if (!didPop && controller.fromPage != 'setting') {
          Message.neutral('Harap lengkapi profil Anda terlebih dahulu.');
        }
      },
      child: Scaffold(
        body: Obx(() {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const Gap(16),
                  Text(
                    'Sedang memperbarui Profil, mohon tunggu...',
